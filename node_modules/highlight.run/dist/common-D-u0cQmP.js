...
const Ri = "exception.message", Li = "exception.stacktrace", Pi = "exception.type", Fi = "service.name", $i = "telemetry.sdk.name", Mi = "telemetry.sdk.version", Ui = "url.full", Bi = "url.path", Vi = "url.query", ji = "user_agent.original", qi = 1e3, Hi = 1e3 * 2, Gi = 4 * 60 * 60 * 1e3, et = 15 * 60 * 1e3, Yi = {
  normal: {
    bytes: 1e7,
    time: 4 * 60 * 1e3
  },
...
}, zi = 100, Ji = "app.highlight.io", Xi = "https://app.launchdarkly.com", Qi = {
...
}, Wi = "/projects/default", Ki = new RegExp("pub\\.(?<domain>.+)");
...
const jr = 10, qr = 1e3, Hr = 500, Gr = [Ht.BillingQuotaExceeded.toString()], Yr = (e) => {
  ...
  return e;
}, C = "feature_flag", Gt = "launchdarkly", Yt = "evaluation", zr = `${C}.${Yt}`, ts = `${C}.set.id`, Jr = `${C}.key`, Xr = `${C}.contextKeys`, Qr = `${C}.context.id`, Wr = `${C}.result.value`, Kr = `${C}.provider.name`, pt = {
...
}, Zr = `${C}.result.variationIndex`, ns = `${Gt}.application.id`, rs = `${Gt}.application.version`, ei = "$ld:telemetry:session:init", ti = "$ld:telemetry:error", mt = "$ld:telemetry:track", ni = "$ld:telemetry:metric", ri = "document_load", is = "result.status";
function gt(e) {
...
}, vt = (e, t) => `${t}${e.trim().split(" ").join(t)}`, ls = (e) => {
  let t;
  const r = () => {
...
//# sourceMappingURL=common-D-u0cQmP.js.map
