...
import { W as $e, M as C, r as G, I as me, a as fe, S as Ve, P as Ke, C as Ae, F as xe, b as qe, c as Ge, d as we, g as je, p as Je, e as Qe, f as Ye, h as Xe, s as Ze, i as et } from "./record-DO35txsx.js";
import { R as Qt } from "./record-DO35txsx.js";
import { A as tt, s as K, G as N, g as B, S as L, r as pe, a as j, b as st, c as it, d as J, e as Q, f as U, F as Se, M as _, h as E, V as nt, i as rt, H as Y, j as ot, k as at, L as Le, l as Ee, p as ct, m as ye, n as be, o as lt, q as dt, t as ht, u as gt, P as ut, v as mt, w as ft, x as wt } from "./common-D-u0cQmP.js";
import { X as pt, F as St, C as yt, E as bt, s as kt, D as vt, a as Rt, m as ke, d as Ne, b as ve, c as Re, r as Oe, e as Dt, p as _t, f as It, g as Ct, h as Lt, W as Et, N as Nt, P as Ot, J as Tt, i as $, B as V, j as Ht, k as De, l as _e } from "./observe-BKxWWCLw.js";
import { O as Xt } from "./observe-BKxWWCLw.js";
import { L as Pt } from "./buffer-DIFxvF2Q.js";
import { LDObserve as es } from "./LDObserve.js";
import { LDRecord as ss } from "./LDRecord.js";
const Ut = (i, e, t) => {
...
class I {
  ...
  startListening() {
    ...
    ), this.listeners.push(kt), I.setupNetworkListener(this, this.options);
  }
  stopListening() {
  ...
  static getRecordedNetworkResources(e, t) {
    ...
    if (!e.disableNetworkRecording) {
      ...
      const d = (t - c) * 2;
      if (s = s.filter((l) => l.responseEnd < e.lastNetworkRequestTimestamp ? !1 : Rt(
        l.name,
        e.highlightEndpoints
      )).map((l) => y(p({}, l.toJSON()), {
...
class Z {
  constructor(e, t) {
    ...
    var n, o, r, c, d;
    e.sessionSecureID || (e.sessionSecureID = N()), this.options = e, typeof ((n = this.options) == null ? void 0 : n.debug) == "boolean" ? this.debugOptions = this.options.debug ? { clientInteractions: !0 } : {} : this.debugOptions = (r = (o = this.options) == null ? void 0 : o.debug) != null ? r : {}, this.logger = new Pt(this.debugOptions.clientInteractions), e.storageMode && (this.logger.log(
        ...
        Nt(
          (r) => {
            ...
            r.saveData !== void 0 && c.push({
              ...
              ([d, l]) => l && typeof l == "number" && this.recordGauge({
                name: d,
                value: l,
...
var Mt = /* @__PURE__ */ ((i) => (i.Device = "Device", i.WebVital = "WebVital", i.Frontend = "Frontend", i.Backend = "Backend", i))(Mt || {});
const b = (i, e) => {
...
const w = {
  ...
  init: (i, e) => {
    ...
    try {
      ...
      e != null && e.sessionCookie ? ft() : Ee(!1);
      const h = B();
      let g = N();
  ...
  registerLD(i) {
    Ce.length || (w.onHighlightReady(() => {
      u.registerLD(i);
    }), mt(this, i, w.options), Ce.push(new Le(i)));
  }
};
...
export {
  ...
  w as H,
  qt as HighlightSegmentMiddleware,
  es as LDObserve,
  ss as LDRecord,
  Mt as MetricCategory,
  Xt as Observe,
  Qt as Record,
  Gt as __testing,
  xt as configureElectronHighlight
};
